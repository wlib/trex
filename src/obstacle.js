...
function Obstacle(
  ...
  this.size = utils.getRandomNum(1, Obstacle.MAX_OBSTACLE_LENGTH);
...
(Obstacle.MAX_OBSTACLE_LENGTH = 3), (Obstacle.prototype = {
  ...
  init(speed) {
    ...
    if (Array.isArray(this.typeConfig.yPos)) {
      var yPosConfig = flags.isMobile
        ? this.typeConfig.yPosMobile
        : this.typeConfig.yPos;
      this.yPos = yPosConfig[utils.getRandomNum(0, yPosConfig.length - 1)];
    } else {
  ...
  update(deltaTime, speed) {
    if (!this.remove) {
      ...
      this.xPos -= Math.floor(speed * flags.FPS / 1000 * deltaTime);
