(function (global, factory) {
    ...
    var isMobile = /Android/.test(window.navigator.userAgent) || isIOS;
    var arcadeModeURL = "chrome://dino/";
    /**
     * Get random number.
     * @param {number} min
     * @param {number} max
    ...
    function getTimeStamp() {
        return isIOS ? new Date().getTime() : performance.now();
    }
    /**
    ...
    var Runner = (function () {
        ...
        Runner.prototype.setSpeed = function (opt_speed) {
            ...
            if (this.dimensions.WIDTH < defaultWidth) {
                var mobileSpeed = speed *
                    this.dimensions.WIDTH /
                    defaultWidth *
        ...
        Runner.prototype.adjustDimensions = function () {
            ...
            if (this.isArcadeMode()) {
                this.dimensions.WIDTH = Math.min(defaultWidth, this.dimensions.WIDTH);
                if (this.activated) {
       ...
       */
         ...
         * @return {boolean}
         */
        Runner.prototype.isArcadeMode = function () {
            return document.title == arcadeModeURL;
        };
        /**
        ...
        Runner.prototype.setArcadeModeContainerScale = function () {
            ...
            var translateY = Math.ceil(Math.max(0, (windowHeight -
                scaledCanvasHeight -
